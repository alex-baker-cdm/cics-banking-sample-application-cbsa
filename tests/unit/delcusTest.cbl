      ...
      *    ---- Test 1: customer with 3 accounts ----
           CALL 'CICSLINK' USING LNK-RESET LNK-CTRL
           CALL 'DB2PROC' USING P-OP-CLEAR FIX-PROC SQLCA
           PERFORM SEED-CUSTOMER
           MOVE 'Y' TO LC-INQOK
           CALL 'CICSLINK' USING LNK-INQOK LNK-CTRL
           PERFORM VARYING WS-I FROM 1 BY 1 UNTIL WS-I > 3
              MOVE WS-ACC(WS-I) TO LC-ACCNO
              CALL 'CICSLINK' USING LNK-ADDAC LNK-CTRL
           END-PERFORM
      ...
      *    DELACC must have been LINKed once per account.
           CALL 'CICSLINK' USING LNK-GETCN LNK-CTRL
           IF LC-NACC = 3
      ...
      *    ...with the right account keys, in order.
           ...
           PERFORM VARYING WS-I FROM 1 BY 1 UNTIL WS-I > 3
              MOVE WS-I TO LC-IDX
              CALL 'CICSLINK' USING LNK-GETAC LNK-CTRL
