...
and `INSERT INTO PROCTRAN` are also supported (see the Db2 sections below).
Other verbs (`ADDRESS`, `GETMAIN`, `RETRIEVE`, …) are **not** yet stubbed — add
them as needed (below).
