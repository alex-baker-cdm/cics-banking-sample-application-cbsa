...
/**
 * Corresponds to the DELCUS COPY structure used by the DELCUS sub-program.
 * Migrated from: COBOL copybook DELCUS.cpy
 */
public class DelCusCommarea {
